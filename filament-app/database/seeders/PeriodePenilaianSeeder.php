...
class PeriodePenilaianSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('periode_penilaians')->insert([
            ...
            [
                'nama_periode' => 'Semester Genap 2020/2021',
                'tanggal_mulai' => Carbon::create(2021, 2, 1),
                'tanggal_selesai' => Carbon::create(2021, 1, 31),
                'status' => 'nonaktif',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            ...
            [
                ...
                'tanggal_mulai' => Carbon::create(2022, 8, 1),
                'tanggal_selesai' => Carbon::create(2023, 1, 31),
                'status' => 'nonaktif',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                'nama_periode' => 'Semester Genap 2020/2021',
                'tanggal_mulai' => Carbon::create(2021, 2, 1),
                'tanggal_selesai' => Carbon::create(2021, 7, 31),
                'status' => 'nonaktif',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                'nama_periode' => 'Semester Genap 2022/2023',
                'tanggal_mulai' => Carbon::create(2023, 2, 1),
                'tanggal_selesai' => Carbon::create(2023, 7, 31),
                'status' => 'nonaktif',
                'created_at' => now(),
                'updated_at' => now(),
            ],
